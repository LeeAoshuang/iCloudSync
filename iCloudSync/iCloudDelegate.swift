...
@objc public protocol iCloudDelegate {
     ...
     */
    @objc optional func iCloudAvailabilityDidChange(to isAvailable: Bool, token ubiquityToken: UbiquityIdentityToken?, with ubiquityContainer: URL?)
     ...
     */
    @objc optional func iCloudDidFinishInitializing(with ubiquityToken: UbiquityIdentityToken?, with ubiquityContainer: URL?)
     ...
     */
    @objc optional func iCloudFileUpdateDidBegin()
    ...
    /**
     ...
     This may be useful to display interface updates.
     */
    @objc optional func iCloudFileUpdateDidEnd()
     ...
     */
    @objc optional func iCloudFilesDidChange(_ files: [NSMetadataItem], with filenames: [String])
     ...
     */
    @objc optional func iCloudFileConflictBetweenCloudFile(_ cloudFile: [String: Any]?, with localFile: [String: Any]?) 
}
